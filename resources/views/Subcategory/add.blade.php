                            ...
                            <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                <div class="col-md-6">
                                    ...
                                    <select name="category" class="single-select">
                                        ...
                                        @foreach ($allcategory as $category)
                                            <option value="{{ $category->id }}">{{ ucfirst($category->category_title) }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="title" name="subcategory_title"
                                        value="{{ old('subcategory_title') }}" placeholder="Enter Subcategory Name"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="subcategory_slug" id="slug"
                                        value="{{ old('subcategory_slug') }}" placeholder="Enter Subcategory Slug"
                                        autocomplete="off" required oninput="NameValidation(this)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" name="subcategory_banner"
                                        value="{{ old('subcategory_banner') }}" placeholder="Enter Sorting Number"
                                        autocomplete="off" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="subcategory_description" id="subcategory_description" rows="3"
                                        oninput="AlphaNumericValidation(this)" required class="form-control" placeholder="Enter Subcategory Description">{{ old('subcategory_description') }}</textarea>
                                ...
                                <div class="col-6 text-end">
                                    <button class="btn rounded-pill btn-primary waves-effect waves-light" type="submit"
                                        id="insert">Add Subcategory > </button>
                                </div>
                            </form>
                        </div>
                    </div>
