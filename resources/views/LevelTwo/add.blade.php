            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Add Level Two</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="title" name="level_two_title"
                                        value="{{ old('level_two_title') }}" placeholder="Enter Level Two Name"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" name="level_two_banner"
                                        value="{{ old('level_two_banner') }}" placeholder="Enter Sorting Number"
                                        autocomplete="off" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="level_two_description" id="level_two_description" rows="3" oninput="AlphaNumericValidation(this)"
                                        required class="form-control" placeholder="Enter Level Two Description">{{ old('level_two_description') }}</textarea>
                                ...
                                <div class="col-6 text-end">
                                    <button class="btn rounded-pill btn-primary waves-effect waves-light" type="submit"
                                        id="insert">Add Level Two > </button>
                                </div>
                            </form>
                        </div>
                    </div>
