            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Edit Level Two</h4>
                    </div>
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="form_update" class="row g-3 needs-validation" novalidate>
                                @method('PUT')
                                <div class="col-md-6">
                                    <label class="form-label">Subcategoy Name *</label>
                                    <input type="hidden" id="id" value="{{ $level_two->id }}">
                                    <input type="hidden" id="get_url" value="{{ url('/leveltwo') }}">
                                    <input type="hidden" id="module_name" value="Level Two">
                                    <select name="subcategory" class="single-select">
                                        <option value="" selected disabled>--Select Subcategory--</option>
                                        @foreach ($allsubcategory as $subcategory)
                                            <option value="{{ $subcategory->id }}"
                                                {{ $subcategory->id == $level_two->subcategory ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Level Two Name *</label>
                                    <input type="text" class="form-control" id="title" name="level_two_title"
                                        value="{{ $level_two->level_two_title }}" placeholder="Enter Level Two Name"
                                        autocomplete="off" required oninput="NameValidation(this)">
                                    <strong class="text-danger" id="level_two_title"></strong>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Level Two Slug *</label>
                                    <input type="text" class="form-control" name="level_two_slug" id="slug"
                                        value="{{ $level_two->level_two_slug }}" placeholder="Enter Level Two Slug"
                                        autocomplete="off" required oninput="NameValidation(this)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="sorting_number"
                                        value="{{ $level_two->sorting_number }}" placeholder="Enter Sorting Number"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" name="add_favicon"
                                        value="{{ $level_two->add_favicon }}" placeholder="Enter Sorting Number"
                                        autocomplete="off">
                                    <strong class="text-danger" id="add_favicon"></strong>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Level Two Banner *</label>
                                    <input type="file" class="form-control" name="level_two_banner"
                                        value="{{ $level_two->level_two_banner }}" placeholder="Enter Sorting Number"
                                        autocomplete="off">
                                    <strong class="text-danger" id="level_two_banner"></strong>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Level Two Description *</label>
                                    <textarea name="level_two_description" id="level_two_description" rows="3" oninput="AlphaNumericValidation(this)"
                                        required class="form-control" placeholder="Enter Level Two Description">{{ $level_two->level_two_description }}</textarea>
                                    <strong class="text-danger" id="level_two_description"></strong>
                                </div>
                                ...
                                <div id="campaign_fields">
                                    @php
                                        $unserializeSection = isset($level_two->section_name) ? unserialize($level_two->section_name) : [];
                                        $unserializeSectionDes = isset($level_two->section_description) ? unserialize($level_two->section_description) : [];
                                        $unserializeproductTitle = isset($level_two->section_product_title) ? unserialize($level_two->section_product_title) : [];
                                        $unserializeproductSupplier = isset($level_two->section_product_supplier) ? unserialize($level_two->section_product_supplier) : [];
                                        $unserializeproductDes = isset($level_two->section_product_description) ? unserialize($level_two->section_product_description) : [];
                                        $unserializeproductImage = isset($level_two->section_product_image) ? unserialize($level_two->section_product_image) : [];
                                        $unserializeproductBrand = isset($level_two->section_product_brand) ? unserialize($level_two->section_product_brand) : [];
                                        $unserializeproductURL = isset($level_two->section_product_url) ? unserialize($level_two->section_product_url) : [];
                                    @endphp
                                ...
                                <div class="col-6">
                                    <a href="{{ url('/leveltwo') }}" type="submit" id="button_move"
                                ...
                                <div class="col-6 text-end">
                                    <button class="btn rounded-pill btn-primary waves-effect waves-light" type="submit"
                                        id="update">Edit Level Two > </button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            $(document).on("change", "input[name='level_two_banner']", function(event) {
                event.preventDefault();
                var file = event.target.files[0];
